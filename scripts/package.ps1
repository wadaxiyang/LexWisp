...
try {
    ...
    $stage = Join-Path $repo 'dist/stage-03'
    ...
    [void]$notices.AppendLine('LexWisp Stage 3 - third-party notices')
    ...
    $archive = Join-Path $repo 'dist/LexWisp-stage-03-windows-x64.zip'
