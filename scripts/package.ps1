...
try {
    ...
    $stage = Join-Path $repo 'dist/stage-04'
    ...
    [void]$notices.AppendLine('LexWisp Stage 4 - third-party notices')
    ...
    $archive = Join-Path $repo 'dist/LexWisp-stage-04-windows-x64.zip'
