...
try {
    ...
    $stage = Join-Path $repo 'dist/stage-05'
    ...
    [void]$notices.AppendLine('LexWisp Stage 5 - third-party notices')
    ...
    $archive = Join-Path $repo 'dist/LexWisp-stage-05-windows-x64.zip'
